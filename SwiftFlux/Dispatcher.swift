...
public protocol Dispatcher {
    func dispatch<T: Action>(action: T, result: Result<T.Payload, T.ErrorType>)
    func register<T: Action>(type: T.Type, handler: @escaping (Result<T.Payload, T.ErrorType>) -> ()) -> DispatchToken
    func unregister(dispatchToken: DispatchToken)
    func waitFor<T: Action>(dispatchTokens: [DispatchToken], type: T.Type, result: Result<T.Payload, T.ErrorType>)
}
...
public class DefaultDispatcher: Dispatcher {
    ...
    public func dispatch<T: Action>(action: T, result: Result<T.Payload, T.ErrorType>) {
    ...
    public func waitFor<T: Action>(dispatchTokens: [DispatchToken], type: T.Type, result: Result<T.Payload, T.ErrorType>) {
    ...
    private func invokeCallback<T: Action>(dispatchToken: DispatchToken, type: T.Type, result: Result<T.Payload, T.ErrorType>) {
